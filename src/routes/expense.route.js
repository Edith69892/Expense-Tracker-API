...
const { addExpense, updateExpense, deleteExpense, getAllTransactions, getFilteredTransaction } = require("../controllers/expense.conntroller.js");
...
router.route("/filter").get(verifyJwt,getFilteredTransaction)
